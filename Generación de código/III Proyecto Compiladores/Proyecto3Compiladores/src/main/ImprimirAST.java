...
public class ImprimirAST extends ParserMiniJavaBaseVisitor<Object>{
    ...
    public Object visitMainClassAST(ParserMiniJava.MainClassASTContext ctx) {
        ...
        //Main.programa.appendASTArea(((TerminalNode) visit(ctx.identifier(0))).getSymbol().getText() + "\n");
        visit(ctx.identifier(0));
        printTab(cont);
        ...
        //Main.programa.appendASTArea(((TerminalNode) visit(ctx.identifier(1))).getSymbol().getText() + "\n");
        visit(ctx.identifier(1));
        printTab(cont);
        //System.out.println(ctx.IDENTIFIER(2).getSymbol().getText());
        //Main.programa.appendASTArea(((TerminalNode) visit(ctx.identifier(2))).getSymbol().getText() + "\n");
        visit(ctx.identifier(2));
    ...
    public Object visitClassAST(ParserMiniJava.ClassASTContext ctx) {
        ...
        //Main.programa.appendASTArea(((TerminalNode) visit(ctx.identifier())).getSymbol().getText() + "\n");
    ...
    public Object visitVarAssignAST(ParserMiniJava.VarAssignASTContext ctx) {
        ...
        //Main.programa.appendASTArea(((TerminalNode) visit(ctx.identifier())).getSymbol().getText() + "\n");
        visit(ctx.identifier());
        //String direccion = (String) ctx.identifier().decl.hashCode();
        //Main.programa.appendASTArea(((String) ctx.identifier().decl.hashCode()));
        visit(ctx.expression());
        cont--;
    ...
    @Override
    public Object visitIdent(ParserMiniJava.IdentContext ctx) {
        Main.programa.appendASTArea(ctx.getClass().getSimpleName() + "\n");
        //printTab((cont++));
        cont++;
        printTab(cont);
        Main.programa.appendASTArea("ID\n");

        cont++;
        printTab(cont);
        Main.programa.appendASTArea(ctx.ID().getSymbol().getText() + "\n");
        cont--;

        if (ctx.decl != null){
            printTab(cont);
            Main.programa.appendASTArea("Decl\n");

            cont++;
            printTab(cont);
            Main.programa.appendASTArea("@" + ctx.decl.hashCode() + "\n");
            cont--;
        }
        cont--;
