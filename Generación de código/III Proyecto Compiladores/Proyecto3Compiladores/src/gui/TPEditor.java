...
public class TPEditor {
    ...
    public JFrame jFrame;            //instancia de JFrame (ventana principal)
    ...
    private JTextArea textArea;      //instancia de JTextArea (área de edición)
    ...
    public TPEditor() {
        ...
        jFrame = new JFrame("Java IDE - Sin Título");
        ...
        c.add(new JScrollPane(textArea), BorderLayout.CENTER);    //añade el area de edición en el CENTRO

        //c.add(new JScrollPane(errorArea), BorderLayout.SOUTH);     //añade
        ...
        //coloca el focus en el área de texto principal
    ...
    private void buildTextArea() {
        ...
        /*textArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK), "none");    //remueve CTRL + X ("Cortar")
        textArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK), "none");    //remueve CTRL + C ("Copiar")
        textArea.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK), "none");    //remueve CTRL + V ("Pegar")*/
    }

    /**
     * Construye el panel para la barra de estado y errores
     */
    private void buildPanelSur(){
        panelSur = new JPanel();
        panelSur.setLayout(new BoxLayout(panelSur, BoxLayout.Y_AXIS));
        panelSur.add(statusBar);
        panelSur.add(new JScrollPane(errorArea));
    }
    ...
    private void buildMenuBar() {
        ...
        itemBackgroundColor.setActionCommand("cmd_backgroundcolor");*/ // Comentario 1
        ...
        menuTools.add(itemBackgroundColor);*/ // Comentario 2
    ...
    private void buildToolBar() {
        ...
        buttonCompile.setIcon(new ImageIcon(getClass().getResource("/res/tp_compile.png")));
        buttonCompile.setActionCommand("cmd_compile");

        JButton buttonRun = new JButton();
        buttonRun.setToolTipText("Ejecutar");
        buttonRun.setIcon(new ImageIcon(getClass().getResource("/res/tp_ejecutar.png")));
        buttonRun.setActionCommand("cmd_run");
    ...
    private void buildPopupMenu() {
        ...
        for (Component c : jPopupMenu.getComponents()) {
            ...
            if (c.getClass().equals(JMenuItem.class)) {
    ...
    // Construye la ventana que muestra el árbol AST
    public void construirVentanaArbol(){
        try {    //LookAndFeel nativo
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        } catch (Exception ex) {
            System.err.println(ex);
        ...
        //construye un JFrame con título
        ventanaAST = new JFrame("Java IDE - AST");
        //ventanaAST.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);

        buildASTArea();
        Container c = ventanaAST.getContentPane();
        c.add(new JScrollPane(ASTArea), BorderLayout.CENTER);

        //configura el JFrame con un tamaño inicial proporcionado con respecto a la pantalla
        ventanaAST.setSize(1000, 700);

        //centra el JFrame en pantalla
        ventanaAST.setLocationRelativeTo(null);

        //coloca el focus en el área de texto principal
        ASTArea.requestFocusInWindow();
    }



    // Construye el TextArea de la ventana AST
    public void buildASTArea() {
        ASTArea = new JTextArea();    //construye un JTextArea

        //se configura por defecto para que se ajusten las líneas al tamaño del área de texto ...
        //textArea.setLineWrap(true);
        //... y que se respete la integridad de las palaras en el ajuste
        ASTArea.setWrapStyleWord(true);
    ...
    public void setErrorArea(String texto){
        this.errorArea.setText(texto + "\n");
    }

    public void appendErrorArea(String texto) {
        this.errorArea.append(texto + "\n");
    }
    ...
    public void appendASTArea(String texto) {
        this.ASTArea.append(texto);
    }

    public void clearASTArea(){
        try {
            this.ASTArea.setText("");
    ...
    class EventHandler extends MouseAdapter implements ActionListener,
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (ac.equals("cmd_new") == true) {    //opción seleccionada: "Nuevo"
                ...
                textArea.paste();
            } else if (ac.equals("cmd_compile") == true){
                actionPerformer.actionCompile();
            } else if (ac.equals("cmd_run") == true){
        ...
        public void caretUpdate(CaretEvent e) {
            ...
            sbCaretPos.setText("Líneas totales: " + textArea.getLineCount() + "     Línea: " + y + " - Columna: " + x);
        }
